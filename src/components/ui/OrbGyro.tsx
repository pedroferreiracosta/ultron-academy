...
export default function OrbGyro(props: Props) {
  const { style, dotColor = '#9aa3ad', accentColor = '#00d4ff', density = 180, dotSize = 105, speed = 42, spinTurns = 1, ball, pointer, width, height } = props
  ...
  useEffect(() => {
    ...
    const render = (now: number) => {
      ...
      const dotCol = css(parseColor(v.dot as string, [154, 163, 173, 1]))
      const accCol = css(parseColor(v.acc as string, [0, 212, 255, 1]))
